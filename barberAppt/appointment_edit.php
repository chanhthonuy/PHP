...
<html>
    ...
    <body>
        ...
        <?php
            ...
            $stmt = $db->prepare('SELECT * FROM appointments WHERE appointment_id = :id');
        ...
        <div style="padding:10px">
            ...
            <div class="space">
                ...
                <div>
                    ...
                    <?php
                        foreach($db->query('SELECT * FROM [barber] ORDER BY [barber_name]') as $item) {
                            $selected = "";
                            if ($event["barber_id"] == $item["barber_id"]) {
                                $selected = " selected";
                            }
                            echo "<option value='".$item["barber_id"]."'".$selected.">".$item["barber_name"]."</option>";
                        }
                    ?>
                    </select>
                </div>
