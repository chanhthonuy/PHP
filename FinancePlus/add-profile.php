...
<body>
	...
	<div id="content-create">
		<form method="post" action="#">
			...
			<input type="text" class="field" name="n_name" placeholder="Name" style="text-align:center;" required autofocus /><br>
			<input type="text" class="field" name="n_link" placeholder="Link to Signin" style="text-align:center;" /><br><br>
			<select class="field" name="n_type" style="text-align:center;" >
				<option value="0" >Cash</option>
				<option value="1" >Debt</option>
				<option value="2" disabled >Receivable</option>
			</select><br><br>
			...
			<br>
			<input type="text" id="ipt1" class="field" placeholder="High Balance" style="text-align:center;" required /><br>
			<input type="hidden" id="num1" name="n_high" required >
			<input type="text" id="ipt2" class="field" placeholder="Low Balance" style="text-align:center;" required /><br>
