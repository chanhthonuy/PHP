	...
	<div id="content-create">
		<form method="post" action="#">
			...
			<table class="color_display" border="1" cellpadding="4" >
				<tr>
					<td id="s_name" style="border-color:#000;font-family:Verdana;" >Sample</td>
					<td id="s_money" style="border-color:#000;font-family:Consolas, Courier;" >$123,456.78</td>
				</tr>
			</table>
			</center>
			<br>
...
<script type="text/javascript">
	...
	function updateSample() {
		...
		var text = $("#text").val();
		var money = $("#money").val();
		$("#s_name").css("background-color", bk);
		$("#s_name").css("color", text);
		$("#s_money").css("background-color", bk);
		$("#s_money").css("color", money);
	}
</script>
</html>