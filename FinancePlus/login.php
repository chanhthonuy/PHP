...
<body>
	...
	<div id="content-login">
		<form method="post" action="#" >
			...
			<input type="text" class="field" name="n_uname" placeholder="Username" id="user" value="<?php echo $_SESSION['uname'] ?>" <?php if($_SESSION['uname']=="")echo"autofocus" ?> /><br>
			<input type="password" class="field" name="n_pwd" placeholder="Password" id="pass" <?php if($_SESSION['uname']!="")echo"autofocus" ?> /><br><br>
