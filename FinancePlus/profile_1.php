                ...
                <table border="1" cellpadding="4" class="tableFont" >
                    <?php foreach ($trans_results as $row): ?>
                        <tr style="background-color:#efefef;" >
                            ...
                            <td style="border-color:#000;width:70px;text-align:center;" ><a href="edit-transaction.php?id=<?php echo $row['id'] ?>" class="btn btn-warning" ></a></td>
                            <td style="border-color:#000;width:80px;text-align:center;" ><a href="delete-transaction.php?id=<?php echo $row['id'] ?>" class="btn btn-danger" ></a></td>
                        </tr>
                    <?php endforeach; ?>
                </table>
                </div>
