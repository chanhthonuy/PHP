...
<body>
	...
	<div id="content-create">
		<form method="post" action="#">
			...
			<select id="type" class="field" name="n_type" style="text-align:center;" >
			...
			<br>
			<input type="textbox" id="ipt1" class="field" placeholder="High Balance" autocomplete="off" style="text-align:center;" required /><br>
			<input type="hidden" id="num1" value="<?php echo $high_balance ?>" name="n_high" required >
			<input type="textbox" id="ipt2" class="field" placeholder="Low Balance" autocomplete="off" style="text-align:center;" required /><br>
			<input type="hidden" id="num2" value="<?php echo $low_balance ?>" name="n_low" required >
			<br>
			<input type="text" class="error" value="<?php echo $err ?>" readonly /><br>
			<br>
			<input id="buttonSubmit" class="sbtn" type="submit" value="Update" />
		</form>
		<a href="profile.php?account=<?php echo $account_number ?>" style="float:right;" >◄ Profile</a>
	</div>
</body>

<script src="js/money.js"></script>
<script type="text/javascript">
	styleDollar("ipt1", "num1", "", "#000", "#bb0000", 100, true);
	styleDollar("ipt2", "num2", "", "#000", "#bb0000", 0, true);
	
	$("#ipt1").val(moneyFormat('<?php echo $high_balance ?>'));
	$("#ipt2").val(moneyFormat('<?php echo $low_balance ?>'));
