...
<body>
	...
	<div style="margin-left:8px;margin-right:8px;" >
				...
				<tbody>
					<?php foreach ($trans_results as $row): ?>
						<tr style="background-color:#efefef;" >
							...
							<td style="border-color:#000;text-align:right;color:<?php if($balance<-0.001) echo $neg; else echo $pos; ?>;" ><script>document.write(moneyFormat('<?php echo $balance ?>'))</script></td>
							...
							<td style="border-color:#000;text-align:right;color:<?php if($row['transfer']<-0.001) echo $neg; else echo $pos; ?>"; ><script>document.write(moneyFormat('<?php echo $row['transfer'] ?>'))</script></td>
                    ...
                    <tr style="background-color:#fff2cc;" >
                        <td style="border-color:#000;background-color:#efefef;text-align:right;color:<?php if($balance<-0.001) echo $neg; else echo $pos; ?>;" ><span id="new_balance" ></span></td>
		...
		<table border="1" cellpadding="4" class="tableFont" style="border:#000;" >
			...
			<tr>
				<td style="border-color:#000;background-color:#434343;text-align:center;" ><a href="error.php?msg=<?php echo "This is a button that needs work." ?>&items=NONE" class="btn btn-primary" >Update Profile</a></td>
			</tr>
			<tr>
